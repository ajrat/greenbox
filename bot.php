...
function freshstate($chat_id){
	...
	$message = "\xE2\x99\xA8Температура воздуха : ".$freshstatearray[0]."\n\xF0\x9F\x92\xA7Влажность воздуха : ".$freshstatearray[1]."\n\xF0\x9F\x9A\xB0Влажность земли : ".$freshstatearray[2]."\n\xF0\x9F\x94\x85Лампы : ".$freshstatearray[3];
